      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative w-full" style={{ padding: "0 1.5rem", zIndex: 10 }}>
          ...
          <div className="max-w-xl">
            ...
            >
              דף נחיתה ממיר: <CountUp to={777} duration={0.6} separator="," className="inline" /> ₪. <br/><CountUp to={7} duration={0.4} className="inline" /> ימי עסקים. בול!
            </h1>
        ...
        <div className="absolute pointer-events-none watermark-blob" style={{ bottom: "-3rem", right: "-3rem", width: "20rem", height: "20rem", borderRadius: "50%", background: "#000000", filter: "blur(40px)", zIndex: 15 }} />
