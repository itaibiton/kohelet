...
export const FeatureCard = ({
  ...
  return (
    <div className="relative group p-6 rounded-sm bg-[#08080a] border border-white/5 overflow-hidden hover:border-white/10 transition-all duration-500 hover:-translate-y-1">
      ...
      <div className="absolute top-0 end-0 text-[0.5625rem] font-mono text-neutral-500 uppercase border border-white/10 px-1 py-0.5 rounded-sm">
        {tag}
      </div>
      ...
      <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-brand/50 to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
    </div>
  );
};
